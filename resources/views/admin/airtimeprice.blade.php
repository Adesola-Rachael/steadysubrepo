                            ...
                            <div class="widget-content widget-content-area">
                                ...
                                <div class="input-group mb-4">
                                    ...
                                    <select class="form-control " id="name" name="network" required="">
                                        ...
                                        <option value='{{ $air->network }}'>{{ $air->network }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <table id="zero-config" class="table table-striped dataTable" style="width: 100%;"
                                ...
                                <tbody>
                                    ...
                                    @for($i=1000;$i<=1100;$i+=1000) <tr role="row">
                                        <td>
                                            @if($data->network == 'GLO')
                                            <span class='badge badge-success'>{{ $data->network }}</span>
                                            @elseif($data->network == 'MTN')
                                            <span class='badge badge-warning'>{{ $data->network }}</span>
                                            @elseif($data->network == 'AIRTEL')
                                            <span class='badge badge-danger'>{{ $data->network }}</span>
                                            @else
                                            <span class='badge badge-secondary'>{{ $data->network }}</span>
                                            @endif

                                        </td>
                                        <td>{{ $i }}</td>

                                        <td>{{ number_format($i - (($data->actual_price/100) * $i) ,2) }}</td>
                                        ...
                                        {{-- <td>
                                            <a data-id='{{ $data->id }}'
                                                class="editdata btn btn-primary btn-sm">Update</a>
                                            <a data-id='{{ $data->id }}'
                                                class="deletedata btn btn-danger btn-sm">Del</a>
                                        </td> --}}
                                        </tr>
                                        @endfor
                                        @endforeach
