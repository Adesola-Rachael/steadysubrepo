                            ...
                            <tbody id='t_body'>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        type='number' id="price{{ $data->id }}" class='form-control'></td><td><a data-price='{{ $data->set_price }}' data-network='{{ $data->network }}' data-name='{{ $data->name }}' data-plan_id="{{$data->plan_id}}" data-id='{{ $data->id }}' class='updateprice btn btn-success'>Update</a></td>`
                    ...
                    $.each( data, function( key, value ) {
                        ...
                        $('#t_body').append(`<tr><td>${network}</td><td>${value.name}</td><td>₦${value.veenode_price}</td>
                              ...
                              <input value='${value.set_price}' 
                                type='number' id="price${value.id}" class='form-control'></td><td><a data-price='${value.set_price}' data-network='${network}' data-name='${value.name}' data-plan_id="${value.plan_id}" data-id='${value.id}' class='updateprice btn btn-success'>Update</a></td>`
                                );  
