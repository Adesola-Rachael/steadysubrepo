                        ...
                        <table id="t_table" class="table table-striped dataTable" style="width: 100%;" role="grid"
                            ...
                            <tbody id='t_body'>
                                ...
                                <tr>
                                    <td>{{ $data->network }}</td>
                                    <td>{{ $data->name }}</td>
                                    <td>{{ $data->veenode_price }}</td>
                                    <td>
                                        <input value='{{ $data->set_price }}'
                                        type='number' id="price{{ $data->id }}" class='form-control'></td><td><a data-price='{{ $data->veenode_price }}' data-network='{{ $data->network }}' data-name='{{ $data->name }}' data-plan_id="{{$data->plan_id}}" data-id='{{ $data->id }}' class='updateprice btn btn-success'>Update</a></td>`
...
<script>
    $(document).ready(function() {
              ...
              if(data !== false) {
                console.log(data,'from sme plug')
                    ...
                    $.each( data, function( key, value ) {
                        ...
                        $('#t_body').append(`<tr><td>${network}</td><td>${value.name}</td><td>₦${value.veenode_price}</td>
                              <td>
                              <input value='${value.set_price}' 
                                type='number' id="price${value.id}" class='form-control'></td><td><a data-price='${value.veenode_price}' data-network='${network}' data-name='${value.name}' data-plan_id="${value.plan_id}" data-id='${value.id}' class='updateprice btn btn-success'>Update</a></td>`
                                );  
      ...
      $('body').on('click','.updateprice', function() {
        ...
        $.get("{{ route('setdata') }}?value="+value, function(data) {
            console.log(data);
            if(data == true) {
